...
// open the database
  ...
  Future<List<Kategori>> kategoriListeGetir() async {
    var kategoritMapListesi = await kategoriGetir();
    var tumKategoriListesi = List<Kategori>();
    for (Map map in kategoritMapListesi) {
      tumKategoriListesi.add(Kategori.fromMap(map));
    }

    return tumKategoriListesi;
  }
  ...
  Future<List<Not>> notListeGetir() async {
    var notMapListesi = await notGetir();
    var tumNotListesi = List<Not>();
    for (Map map in notMapListesi) {
      tumNotListesi.add(Not.fromMap(map));
    }

    return tumNotListesi;
  }
